  ...
  <body>
    ...
    <nav>
        <div class="btext">
          <?php
          $log = $_SESSION['logina'];
          $dados = mysqli_query($conexao, "SELECT login FROM adm WHERE login = '$log'");
          while($nome = mysqli_fetch_assoc($dados))
          {
            echo "<p>Olá, " . $nome['login'] . "</p>";
          }
          ?>
        </div>
              <a class="btn" href="logout.php">Sair</a>
              <a class="btn" href="aconsultas.php">Consultas</a>
              <a class="btn" href="ptab.php">Pacientes</a>
              <a class="btn" href="mtab.php">Médicos</a>
      </nav>
    <div id="dov">
